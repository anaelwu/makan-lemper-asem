 ...
 * property controls the text displayed in the label for the switch,
...
public class Switch extends CompoundButton {
	...
	private int						mThumbWidth;									// Does not
																					// include
																					// padding
	...
	public Switch(Context context, AttributeSet attrs) {
		this(context, attrs, R.attr.switchStyle_bp);
	}
	...
	public Switch(Context context, AttributeSet attrs, int defStyle) {
		...
		mThumbTextPadding = a.getDimensionPixelSize(R.styleable.Switch_thumbTextPadding_bp, 0);
		mSwitchMinWidth = a.getDimensionPixelSize(R.styleable.Switch_switchMinWidth_bp, 0);
		mSwitchPadding = a.getDimensionPixelSize(R.styleable.Switch_switchPadding_bp, 0);

		final int appearance = a.getResourceId(R.styleable.Switch_switchTextAppearance_bp, 0);
		if (appearance != 0) {
	 ...
	 * variants, so you may need to use {@link #setSwitchTypeface(android.graphics.Typeface, int)}
	...
	public void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
		...
		final int switchWidth = Math
				.max(mSwitchMinWidth, maxTextWidth * 2 + mThumbTextPadding * 4 + mTempRect.left
						+ mTempRect.right);
