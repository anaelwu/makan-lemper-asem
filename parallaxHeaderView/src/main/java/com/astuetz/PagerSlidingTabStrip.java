...
public class PagerSlidingTabStrip extends HorizontalScrollView {
	...
	private int							indicatorColor			= 0xEEC6C6C6;
	...
	public PagerSlidingTabStrip(Context context, AttributeSet attrs, int defStyle) {
		...
		// LayoutParams.MATCH_PARENT);
		defaultTabLayoutParams = new LinearLayout.LayoutParams(dm.widthPixels / this.mCountPage,
				LayoutParams.MATCH_PARENT);
		expandedTabLayoutParams = new LinearLayout.LayoutParams(dm.widthPixels / this.mCountPage, LayoutParams.MATCH_PARENT, 1.0f);
